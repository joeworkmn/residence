...
ActiveRecord::Schema.define(version: 20130914080225) do
  ...
  add_index "apartments", ["reset_password_token"], name: "index_apartments_on_reset_password_token", unique: true, using: :btree
